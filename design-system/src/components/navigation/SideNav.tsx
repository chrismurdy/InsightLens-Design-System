...
export function SideNav({ items = [], activeId, onSelect, logo, width = 232, footer, style }: SideNavProps) {
  return (
    <nav style={{
            ...
            <li key={it.id}>
              <button
                ...
                style={{
                  ...
                  fontWeight: (active ? "var(--il-weight-bold)" : "var(--il-weight-semibold)") as React.CSSProperties["fontWeight"],
                    ...
                    <li key={k.id}>
                      <button onClick={() => onSelect && onSelect(k.id)} className="il-small"
                        style={{ background: "none", border: 0, padding: 0, cursor: "pointer", font: "inherit",
                          ...
                          fontWeight: (k.id === it.activeChildId ? "var(--il-weight-semibold)" : "var(--il-weight-regular)") as React.CSSProperties["fontWeight"] }}>
